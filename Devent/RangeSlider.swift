...
class RangeSlider: UIControl {
    ...
    var trackHighlightTintColor: UIColor = UIColor(red: 255/255, green: 41/255, blue: 135/255, alpha: 1.0) {
        didSet {
            trackLayer.setNeedsDisplay()
        }
    }
    ...
    override init(frame: CGRect) {
        ...
        print("Initial frame of the slider is \(frame)")
    ...
    func updateLayerFrames() {
        ...
        print("Initial frame of the slider elements is \(bounds)")
